...
const PluginState = require('./PluginState.enum.js');

Object.defineProperty(module.exports, "PluginState", {
  configurable: false,
  enumerable: true,
  value: PluginState
});
...
Object.defineProperty(Plugger, "PluginState", {
  configurable: false,
  enumerable: true,
  value: PluginState
});
...
Plugger.prototype.activate = function(pluginName, plugin, modulePath, data) {
  ...
  this.pluginPaths.set(pluginName, modulePath);
  ...
  function activatePlugin(pluginName, cb) {
    ...
    function callback(pluginData) {
      if (activePlugin.state > 0) {
        debug("!! CONNECT: active plugin '" + pluginName + "' is already connected!")
        return cb(null, true);
      }
...
Plugger.prototype.load = function(modulePath, cb) {
...
Plugger.prototype.reactivate = function(plName, cb) {
  var loader = this;
  var plPath = loader.getPluginPath(plName);
  if(plPath===null) {
